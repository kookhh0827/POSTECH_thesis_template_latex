...
\begin{document}
    ...
    \input{chapters/04_mpinit}
    \input{chapters/05_trsg}
    ...
    \curriculumvitae[english]
        ...
        \begin{education}
            \item[2024. 03.\ --\ 2026. 02.] M.S., Department of Computer Science and Engineering, Pohang University of Science and Technology
            % TODO: 학사 학력 추가
            % \item[YYYY. MM.\ --\ YYYY. MM.] B.S., Department of ???
        \end{education}
