...
\begin{itemize}[leftmargin=2em]
    ...
    \item \textbf{Comprehensive empirical validation.} On CIFAR-10/100, ImageNet, and DVS-CIFAR10, our combined method achieves state-of-the-art accuracy at competitive timesteps. We further demonstrate that MP-Init and TrSG transfer cleanly to Transformer-based SNN backbones and to event-based object detection, indicating broad applicability.
\end{itemize}
