...
\begin{figure}[t!]
  ...
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_membrane_potential_tdbn.pdf}
    \caption{tdBN}
    \label{fig:membrane_potential_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_membrane_potential_tebn.pdf}
    \caption{TEBN}
  \end{subfigure}
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_membrane_potential_tab.pdf}
    \caption{TAB}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_membrane_potential_mpinit.pdf}
...
\begin{figure}[t!]
  \centering
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_presynaptic_input_tdbn.pdf}
    \caption{tdBN}
    \label{fig:presynaptic_input_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_presynaptic_input_tebn.pdf}
    \caption{TEBN}
  \end{subfigure}
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_presynaptic_input_tab.pdf}
    \caption{TAB}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\linewidth}
    \includegraphics[width=0.99\linewidth]{fig/density_plot_presynaptic_input_mpinit.pdf}
    \caption{MP-Init (ours)}
  \end{subfigure}
...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{TV distance of the membrane-potential distribution between timestep~10 and previous timesteps under different $V_{\text{thr}}$ (left) and $\tau$ (right). Inputs are sampled from a Gaussian distribution.}
  \label{fig:tv_norm}
\end{figure}
